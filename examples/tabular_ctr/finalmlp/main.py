...
from scarabs.mora.models.ctr_with_finalmlp import CtrWithFinalMLP, CtrWithFinalMLPConfig
...
# # Train
config = CtrWithFinalMLPConfig.from_pretrained(
    os.path.join(
...
task.train(model=CtrWithFinalMLP(config))
